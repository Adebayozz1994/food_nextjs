...
export default function Products() {
  ...
  // Memoize fetchProducts so it's not re-created on every render.
  ...
  // Memoize fetchCartCount so it’s stable across renders.
                    ...
                    {product.isAvailable ? (
                      <div className="space-y-2">
                        <button
                          ...
                          className="w-full bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition-colors duration-300 disabled:bg-gray-400 flex items-center justify-center transform hover:scale-[1.02] active:scale-[0.98] text-base font-semibold"
                        >
